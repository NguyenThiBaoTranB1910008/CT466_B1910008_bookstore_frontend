...
function NewAddress({setChoose, user, locate}){
    ...
    useEffect(()=>{
        var idprovince =listProvince.find((province) => province.ProvinceName === locate.city).ProvinceID
    ...
    const formik = useFormik({
        initialValues: {
            ...
            city: locate.city ? idProvince : "",
            district: locate.district ? locate.district : "",
            ward: locate.ward ? locate.ward : ""
        },
